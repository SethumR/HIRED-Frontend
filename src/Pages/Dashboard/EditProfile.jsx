  ...
  return (
    <div className="min-h-screen bg-[#0b0f1c] text-white p-8">
      <div className="max-w-5xl mx-auto space-y-8">
        <h1 className="text-3xl font-semibold mt-20">Edit Your Profile</h1>
          ...
          <div className="md:col-span-2 space-y-6">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2 mt-2">
                ...
                <button className="px-3 py-1 border border-dashed border-gray-600 rounded-full text-sm text-gray-400">
                  + Add Skill
                </button>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="mt-2 border-2 border-dashed border-gray-700 rounded-lg p-8 text-center">
                <input
                  type="file"
                  id="resume"
                  className="hidden"
              ...
              <div className="space-y-3">
                {Object.keys(profileData.socialLinks).map((platform) => (
                  <div key={platform} className="flex items-center space-x-2">
                    {platform === "linkedin" && <Linkedin className="w-5 h-5 text-gray-400" />}
                    {platform === "github" && <Github className="w-5 h-5 text-gray-400" />}
                    {platform === "twitter" && <Twitter className="w-5 h-5 text-gray-400" />}
                    <input
                      type="text"
        ...
        <div className="flex justify-end space-x-4 mt-6">
          <button className="bg-gray-700 px-4 py-2 rounded-lg text-sm font-medium">Cancel</button>
          <button onClick={handleSave} className="bg-blue-500 px-4 py-2 rounded-lg text-sm font-medium">
            Save Changes
          </button>
        </div>
      </div>
