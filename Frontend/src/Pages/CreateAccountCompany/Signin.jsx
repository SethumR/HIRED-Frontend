        ...
        {isLoading && (
          ...
          >
            ...
            >
              ...
              {/* Loading Text */}
              <motion.p 
                className="mt-4 text-xl font-medium bg-gradient-to-r from-purple-400 to-pink-400 text-transparent bg-clip-text"
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.97 }}
            className="w-full bg-gradient-to-r from-purple-500 to-pink-500 font-bold py-2 rounded-lg hover:from-pink-500 hover:to-purple-500 transition-all duration-300 ease-in-out shadow-lg"
            disabled={isLoading}
          >
